...
public class DatMonActivity extends AppCompatActivity {
    ...
    private void insertDHOnline(String sdtkh, Double tongtien, int maCuaHang, String diaChi, String pttt) {
        ...
        Request request = new Request.Builder().url("http://10.0.2.2:8080/KFC_ChainStores/donHang/insertDHOnline/" +
    ...
    private void insertCTDH(int maCuaHang) {
        ...
        OkHttpClient client = new OkHttpClient();
        Request getMaHoaDon = new Request.Builder().url("http://10.0.2.2:8080/KFC_ChainStores/donHang/getMaDonHangMoiNhat/" +
                maCuaHang).build();
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                try {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        int soluong = cursor.getInt(4);
                        OkHttpClient client = new OkHttpClient();
                        Request insertCTHD = new Request.Builder().url("http://10.0.2.2:8080/KFC_ChainStores/chiTietDonHang/insert/" +
